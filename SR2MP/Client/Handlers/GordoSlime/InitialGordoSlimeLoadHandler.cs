...
public sealed class InitialGordoSlimeLoadHandler : BaseClientPacketHandler<InitialGordosPacket>
{
    public InitialGordoSlimeLoadHandler(Client client, RemotePlayerManager playerManager)
