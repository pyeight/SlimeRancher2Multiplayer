...
{   // Type                       // Hierarchy                                    // Frequency                          // Use Case
    ...
    GordoSlimeFeed = 43,          // Both Ways                                    Medium (manual)                       On Gordo Slime Fed
    GordoSlimeBurst = 44,         // Both Ways                                    Low (depends on feed)                 On Gordo Slime Burst
    InitialGordoSlimes = 45,      // Server -> Client                             Low (depends on join)                 Gordo Slimes on Load
    ...
    DroneCloud = 95,              // Both Ways                                    Medium                                On Quantum Cloud amount change (absolute)
    DroneCloudExtraction = 96,    // Both Ways                                    Low (manual)                          On Quantum Cloud extraction mode assigned
    InitialDroneCloud = 97,       // Server -> Client                             Low (depends on join)                 Quantum Cloud on join
    DroneEvent = 98,              // Both Ways                                    Medium (depends on count)             Drone Events (notifications)
    DroneAnimation = 99,          // Both Ways                                    Medium (depends on count)             Drone Animations
    ...
    InitialDroneResources = 102,  // Server -> Client                             Low (depends on join)                 Explorer drone resources spots on join
    DroneResourceUpdate = 103,    // Both Ways                                    Low                                   Resource spot data changed
    ConversationPlayed = 104,     // Both Ways                                    Low (manual)                          On Conversation played
